<script>
    ...
    */
    function makeSeen(chat_room_id) {
        ...
        // seen
        $.ajax({
            url: chat_baseurl + "stylist-messanger-read",
            method: "POST",
    ...
    */
    ...
    function sendTempMessageCard(message, id) {
        ...
        html +='            </div>';
        html +='        </div>';
        html += '       <img src="'+(auth_profile != '' ? auth_profile : '{{asset('common/images/default_user.jpeg')}}')+'" class="chat-pic ml-1" alt="Avatar">';
        html +='    </div>';
        html +='</div>';
