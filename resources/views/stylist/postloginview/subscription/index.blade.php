...
<div class="app-content content bg-white">
      ...
      <div class="content-body">
         ...
         <div class=" flex-md-row mt-lg-3 row">
                  ...
                  <div class="col-4 text-right mt-2">
                      <a href="{{ route('stylist.subscription.billing.index')}}" class="h4  view-billing-history">View Billing History <i class="ft-arrow-up-right"></i></a>
                  </div>
  ...
  @section('page-scripts')
      ...
      @include('scripts.stylist.subscription.index_js')
