            ...
            <div class="mt-lg-3 row">
                ...
                <div class="col-4 quick-link text-right">
                    ...
                    <div class="d-flex justify-content-end my-2">
                        <a href="" class="mx-lg-1"><img
                                src="{{ asset('stylist/app-assets/images/icons/Chat.svg') }}" alt=""></a>
                        <a href="" class="mx-1"><img
                                src="{{ asset('stylist/app-assets/images/icons/File Invoice.svg') }}"
                                alt=""></a>
                        <a href="" class="mx-lg-1"><img
                                src="{{ asset('stylist/app-assets/images/icons/Gear.svg') }}" alt=""></a>
            ...
            <div id="browse-soursing" class="mt-5">
                ...
                <div class="text-lg-left text-center mt-3">
                    ...
                    <h2 class="px-2 mt-1 col-lg-5 col-6 text-lg-left text-center"> </h2>
                        <a href="{{ url('/stylist-create-source-request') }}" class=" col-lg-3 col-6 mt-2 text-lg-left text-center">
                            <button class="request-btn px-2">Make Request</button>
                        </a>
                </div>
