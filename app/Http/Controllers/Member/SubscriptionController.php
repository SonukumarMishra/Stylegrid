...
class SubscriptionController extends BaseController
{
    ...
    public function index()
	{
        try{
    		...
    		return view('member.dashboard.subscription.index');
    ...
    public function getSubscriptionList(Request $request)
	{
        try{
            ...
            $user_details = Member::find($this->auth_user['user_id']);

            $view = '';

            $view = view("member.dashboard.subscription.index-list-ui", compact('result', 'user_details'))->render();
        ...
        try {
            ...
            if ($validator->fails()) {
                ...
                if($subscription_info){
                    ...
                    $auth_user = Member::find($this->auth_user['user_id']);
