    ...
    window.onload = function() {
        ...
        CreateGridRef.initEvents = function() {
            ...
            $('body').on('click', '.grid-item-inner-input-block', function(e) {
                ...
                $('#item-modal-image-title').html('Upload an image of the product here');

                $('#modal_product_img_block').addClass('p_25');
            ...
            $('body').on('click', '.add-item-block-btn', function(e) {
                ...
                if (item_block_count < 7) {
                    ...
                    html+= '                            <div class="Neon-input-dragDrop grid-item-inner-input-block d-flex align-items-center height_200 p_25" data-inner-index="'+temp_count+'"  data-parent-index="'+index+'">';
                        ...
                        reader.onload = function (e) {
                            ...
                            if(parent_index != undefined){
                                ...
                                if(obj_index != -1){
                                    ...
                                    $('.style-grid-feature-image-block[data-index="'+parent_index+'"]').removeClass('border-2 border-danger p_25');
            ...
            $('body').on('change', "#stylegrid_item_frm input[name=product_image]", function(e) {
                ...
                if(is_valid_file.is_valid == false){
                    ...
                    $('#modal_product_img_block').removeClass('p_25');
                }
        ...
        CreateGridRef.loadStyleGridUI = function(index) {
            ...
            html+= '                            <div class="Neon-input-dragDrop grid-item-inner-input-block d-flex align-items-center height_200 p_25" data-inner-index="1" data-parent-index="'+index+'">';
