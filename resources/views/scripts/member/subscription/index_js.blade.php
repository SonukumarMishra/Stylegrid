    ...
    window.onload = function() {
        ...
        SubscriptionRef.initEvents = function() {
            ...
            $('body').on('click', '.buy-subscription', function(e) {
                ...
                getResponseInJsonFromURL('{{ route("member.subscription.check_already_purchased_cancelled") }}', formData, (response) => {
                    ...
                    if(response.status == 1){
                        ...
                        if(response.data.subscription_purchased != undefined && response.data.subscription_purchased == 1){
                            ...
                            html += '<h6 class="text-center"><a href="{{route('member.subscription.billing.index')}}">Click Here</a>  to view billing details.</h6>';
