    ...
    public function addStylist(Request $request){
        if($request->ajax()){
            ...
            $save_data=array(
                ...
                'styling_experience'=>$request->styling_experience,
                'fashion_styling_brief'=>$request->fashion_styling_brief,
                'client_brief'=>$request->client_brief,
                'fashion_beauty_brands'=>$request->fashion_beauty_brands,
                'stronger_experience'=>$request->stronger_experience,
